...
public class Main {
    public static void main(String[] args)throws Exception {
        ...
        entrance.setCustomer(customer1);
        entrance.entrance(customer1);
        ...
        havale.setAcount1(acount1);
        havale.setAcount2(acount2);
        havale.setCustomer1(customer1);
        havale.setCustomer2(customer2);

        havale.setTutar(200);

        havale.aktar(acount1);
        ...
        paraCek.setAcount(acount1);
        paraCek.paraCek(100);

        System.out.println("-------");

        ParaYatir paraYatir= new ParaYatir();
        paraYatir.setAcount(acount2);
